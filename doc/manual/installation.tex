...
%Basically, it is straightforward to adapt your \texttt{beamer} presentation to
%the official LS design. After placing files somewhere into the \TeX{} file
%tree (see above), the only this necessary
